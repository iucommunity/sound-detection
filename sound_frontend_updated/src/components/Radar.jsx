...
const Radar = ({ classInfos, points = [], isRunning = true }) => {
      ...
      <div className="absolute top-6 right-6 flex flex-col gap-3">
        ...
        <div className="bg-radar-surface/80 backdrop-blur-md rounded-lg p-2.5 border border-radar-grid/50 shadow-xl">
          <div className="text-xs font-mono space-y-1">
            ...
            {Object.values(classInfos).map((class_data) => {
              ...
              const actualColor = class_data.color;
              
              return (
                <div key={class_data.name} className="flex items-center gap-2 text-gray-300">
                  <div
                  ...
                  />
                  <span className="text-[10px] text-gray-300 font-medium">{class_data.name}</span>
                </div>
              );
            })}
          </div>
