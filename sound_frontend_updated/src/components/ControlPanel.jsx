...
const ControlPanel = ({ points, isRunning, onToggleRunning, onOpenSettings }) => {
  ...
  return (
    <div className="h-full flex flex-col p-6 space-y-6 overflow-y-auto">
      ...
      <div className="mt-auto pt-4 border-t border-radar-grid/30">
        <button
          onClick={onOpenSettings}
          className="w-full px-4 py-3.5 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg bg-gradient-to-r from-radar-surface/60 to-radar-surface/40 text-gray-300 border-2 border-radar-grid/40 hover:border-radar-primary/60 hover:shadow-radar-primary/20 hover:text-radar-primary flex items-center justify-center gap-2"
        >
