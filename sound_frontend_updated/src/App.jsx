...
function App() {
  ...
  const [classInfos, setClassInfos] = useState({}); // Distance parameters received from WebSocket
  ...
  useEffect(() => {
    ...
    const connectWebSocket = () => {
      ...
      const tryConnect = (portIndex) => {
        ...
        const wsUrl = `ws://192.168.130.254:${port}`;
      ...
      <div className="flex-1 flex overflow-hidden min-h-0 relative z-10">
        ...
        <div className="flex-1 flex flex-col p-6 min-h-0 relative overflow-y-auto custom-scrollbar">
          ...
          <div className="flex-shrink-0 flex items-start justify-center pt-4">
            <Radar points={points} isRunning={isRunning} classColors={classColors} classInfos={classInfos} />
          </div>
